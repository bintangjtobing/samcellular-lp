            ...
            <div className="position-relative rounded-16 overflow-hidden z-1 p-32">
              ...
              <div className="flex-between flex-wrap gap-16">
                ...
                <div className="pe-xxl-4">
                  <img
                    src="https://res.cloudinary.com/dilb4d364/image/upload/v1737629332/ea62c9d7-821e-4f27-9325-657d65e1082a.png"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div className="col-lg-6 col-sm-6">
            <div className="position-relative rounded-16 overflow-hidden z-1 p-32">
              ...
              <div className="flex-between flex-wrap gap-16">
                ...
                <div className="pe-xxl-4">
                  <img
                    src="https://res.cloudinary.com/dilb4d364/image/upload/v1737629121/0c2fecfe-4313-46ee-98ea-b396a8ee891d.png"
                    alt=""
                  />
                </div>
              </div>
